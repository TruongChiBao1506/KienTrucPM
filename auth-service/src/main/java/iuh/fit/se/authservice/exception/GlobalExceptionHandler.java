...
/**
     * Handle exception when the user not have permission to access the resource
     *
     * @param e
     * @param request
     * @return
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "403", description = "Forbidden",
                    content = {@Content(mediaType = APPLICATION_JSON_VALUE,
                            examples = @ExampleObject(
                                    name = "403 Response",
                                    summary = "Handle exception when user not have permission to access the resource",
                                    value = """
                                            {
                                              "status": 403,
                                              "path": "/api/v1/...",
